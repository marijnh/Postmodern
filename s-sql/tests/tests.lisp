...
(test drop-table-variations
  (let ((table-var1 "table1")
    ...
    (is (equal (sql (:drop-table :if-exists "table1" :cascade))
               "DROP TABLE IF EXISTS table1 CASCADE"))
    (is (equal (sql (:drop-table :if-exists 'table1 :cascade))
               "DROP TABLE IF EXISTS table1 CASCADE"))
    ...
    (is (equal (sql (:drop-table :if-exists "table1"))
               "DROP TABLE IF EXISTS table1"))
    (is (equal (sql (:drop-table :if-exists 'table1))
               "DROP TABLE IF EXISTS table1"))
    ...
    (is (equal (sql (:drop-table "table1" :cascade))
               "DROP TABLE table1 CASCADE"))
    (is (equal (sql (:drop-table 'table1 :cascade))
               "DROP TABLE table1 CASCADE"))
    ...
    (is (equal (sql (:drop-table table-var1))
               "DROP TABLE table1"))
    (is (equal (sql (:drop-table "table1"))
               "DROP TABLE table1"))
    (is (equal (sql (:drop-table 'table1))
               "DROP TABLE table1"))
