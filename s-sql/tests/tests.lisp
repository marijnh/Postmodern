...
(test analyze
  ...
  (is (equal (sql (:analyze :option (:verbose 1) (:skip-locked 0) (:buffer-usage-limit "70MB")
                            :tables (:t1 't1c1 't1c2) (:t2 't2c1 't2c)))
		         "ANALYZE (VERBOSE TRUE, SKIP_LOCKED FALSE, BUFFER_USAGE_LIMIT 70MB) t1(t1c1, t1c2), t2(t2c1, t2c)"))
  (is (equal (sql (:analyze :option (:verbose :off) (:skip-locked :on) (:buffer-usage-limit "70MB")
                            :tables (:t1 't1c1 't1c2) (:t2 't2c1 't2c)))
  ...
  (is (equal (sql (:analyze))
		         "ANALYZE "))
  (is (equal (sql (:analyze :verbose :tables 't1))
             "ANALYZE VERBOSE t1"))
  (is (equal (sql (:analyze :verbose :tables :t1))
             "ANALYZE VERBOSE t1"))
  (is (equal (sql (:analyze :option (:verbose t) (:skip-locked nil) (:buffer-usage-limit "70MB")
                            :tables (:t1 't1c1 't1c2) (:t2 't2c1 't2c)))
		         "ANALYZE (VERBOSE TRUE, SKIP_LOCKED FALSE, BUFFER_USAGE_LIMIT 70MB) t1(t1c1, t1c2), t2(t2c1, t2c)"))
  (is (equal (sql (:analyze :option (:verbose t) (:skip-locked nil) (:buffer-usage-limit "70MB")
                            :tables (:t1 't1c1 't1c2)))
  ...
  (is (equal (sql (:analyze :option (:verbose t) (:skip-locked nil) (:buffer-usage-limit "70MB")
                            :tables (:t1 't1c1 't1c2)))
		         "ANALYZE (VERBOSE TRUE, SKIP_LOCKED FALSE, BUFFER_USAGE_LIMIT 70MB) t1(t1c1, t1c2)"))
  (is (equal (sql (:analyze :verbose :option (:verbose t) (:skip-locked nil) (:buffer-usage-limit "70MB")
                   :tables (:t1 't1c1 't1c2)))
		         "ANALYZE (VERBOSE TRUE, SKIP_LOCKED FALSE, BUFFER_USAGE_LIMIT 70MB) t1(t1c1, t1c2)")))
