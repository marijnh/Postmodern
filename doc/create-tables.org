...
form where the first atom in the form is the keyword :temp., then the name of
the table. You can optionally use the :if-not-exists keyword in a subform
wrapping the name of the temporary table. E.g.
