...
(test string-to-usb-array
  (is (equal (cl-base64:base64-string-to-usb8-array
...
(test c-nonce-string-to-byte-array
  (is (equal (cl-base64:base64-string-to-usb8-array (cl-base64:string-to-base64-string "fyko+d2lbbFgONRv9qkxdawL"))
             #(102 121 107 111 43 100 50 108 98 98 70 103 79 78 82 118 57 113 107 120 100 97
               119 76))))

(test ironclad-ascii-string-to-byte-array
  (is (equal (ironclad:ascii-string-to-byte-array "QSXCR+Q6sek8bf92")
             #(81 83 88 67 82 43 81 54 115 101 107 56 98 102 57 50))))


(test utf-8-bytes-to-string
  (is (equal (trivial-utf-8:utf-8-bytes-to-string (ironclad:ascii-string-to-byte-array "QSXCR+Q6sek8bf92"))
             "QSXCR+Q6sek8bf92")))
